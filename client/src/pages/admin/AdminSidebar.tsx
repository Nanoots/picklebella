...
export default function AdminSidebar({ section, onSelect, onLogout, open, onClose }: Props) {
  ...
  return (
    <>
      ...
      <aside
        style={{
          width: '240px', flexShrink: 0, backgroundColor: 'white', borderRight: '1px solid #EEF0ED',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '1.25rem 1.25rem 1rem' }}>
          ...
          {isNarrow && (
            <button
              ...
              style={{ border: 'none', background: 'transparent', color: '#6B7280', cursor: 'pointer', padding: '0.35rem', display: 'flex' }}
            >
              <X size={20} />
            </button>
          )}
